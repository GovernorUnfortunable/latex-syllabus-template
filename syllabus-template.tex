...
% Course information
\begin{tabular}{ l l }
  \multirow{4}{*}{\includegraphics[height=1in]{Logo_Flacso.png}} & \textcolor{AzulFlacso} {\textbf{\LARGE Diplomado de Métodos}} \\\\ & \LARGE Introducción a Python para Ciencias Sociales\\
...
\begin{tabular}{ l l }
  ...
  & \href{https://www.governorunfortunable.github.io/IntroPyFLACSO}{governorunfortunable.github.io/IntroPyFLACSO}  \\ % http://username.github.io/repository
